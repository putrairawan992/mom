...
export default function ProductListAnswerQuestion(props) {
      ...
      render: (text, product) => (
        <span className="mp-table-product-action">
          <div className="mp-icon-container">
            <Link to={{ pathname:`${PATH_QUESTION_ANSWER.GET_QUESTION_ANSWER}/${product.id}`,  
            state: {nameIdn: product.nameIdn}}}>
