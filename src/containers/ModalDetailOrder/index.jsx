...
const ModalDetailOrder = ({ invoice, visible, onOk }) => {
  console.log("invoice", invoice.order);
  return (
    <Modal
      bodyStyle={{ padding: "0" }}
        ...
        <div key={item.id}>
          <Row className="supplier__modal__detail-order">
            ...
            <Col md={20} className="supplier__modal__detail-order__variant">
              ...
              <Row>
                  <Col md={3}>Paid Time</Col>
                  <Col md={1}>:</Col>
                  <Col md={20}>{convertTimesTime.millisecond(invoice.order.orderActivityDate.orderDate)}</Col>
              </Row>
              <Row>
                  <Col md={3}>Delivery</Col>
                  <Col md={1}>:</Col>
                  <Col md={20}>By {item.shipment.via}</Col>
              </Row>
              <Row>
                <Col md={14}>
                  <OrderVariant
